...
/**
 * Daily cleanup: expired consent requests (parent emails), sessions, rate-limit windows, processed
 * Stripe event ids older than 30 days (Stripe stops retrying after three), Stripe clean-up that
 * failed earlier (retried with backoff), and Stripe customers nobody can use any more (a household
 * whose last parent left, once its plan has ended).
 */
