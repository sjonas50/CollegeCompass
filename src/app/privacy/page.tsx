  ...
  return (
    <>
      ...
      <Card className="space-y-3 text-sm leading-relaxed">
        ...
        <p><strong>Family income:</strong> we never ask for it. When you pick an income range to see college prices, that choice stays in your browser and isn&apos;t sent to us.</p>
