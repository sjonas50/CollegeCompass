  ...
  return (
    <>
      ...
      <Card className="space-y-3 text-sm leading-relaxed">
        ...
        <p><strong>Your control:</strong> parents can download a copy of their child&apos;s data, or delete it, at any time from their parent page. The parent page shows progress, activity results and plans, never chats with our AI counselor. Students can download a complete copy of their own data, chats included, from Settings on their dashboard. Teens who own their account (they were 13 or older when it was made) can delete it there too; a parent deletes an account they set up for a child under 13. Those teens can also remove a linked parent or guardian from Settings.</p>
        <p><strong>Parent invitations:</strong> when a teen invites a parent or guardian, we keep the email address they typed so the teen can see where the invitation went. Only the teen sees it; it isn&apos;t in a parent&apos;s download. We delete it when the teen cancels the invitation, after the invitation expires if nobody accepted it, and when the teen removes the parent who accepted it or that parent deletes their account.</p>
