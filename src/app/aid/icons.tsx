...
// Small line icons for the aid guide. Always decorative: every icon sits next to a text label.
// This file has no other imports, so the client-side Print button can use it cheaply.
