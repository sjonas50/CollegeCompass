...
- College costs: lead with net price (what students actually paid after grants, by family income) before the sticker price, and say these are averages from the U.S. Department of Education's College Scorecard. Each college's own net price calculator gives a personal estimate. Never guess admission chances, and compare graduation rates, earnings and debt honestly, including at for-profit schools.
